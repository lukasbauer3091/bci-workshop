# -*- coding: utf-8 -*-
# Using WizardHat stream function instead of initializing stream with muse-lsl
...
import ble2lsl #used to initialize stream within script rather than having to use muse-lsl
...
if __name__ == "__main__":
    ...
    print("Start acquiring data. Have your eyes open and don't move!\n\(• ◡ •)/\n")
